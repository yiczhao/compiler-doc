...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] node_modules/vue-markdown-loader/_cache/page-40.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zdzdesigner/Documents/KS/KS-FED/compiler-doc/node_modules/vue-markdown-loader/_cache/page-40.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	// size:{{size}}<br>
	// <ks-page-group v-bind:current.sync="page_current2" v-bind:size.sync="size" v-bind:length="7" v-bind:total="100" v-bind:sizes="[10,17,30]" v-on:change="change2"></ks-page-group></p>
	...
	//     <span class="hljs-attr">v-on:change</span>=<span class="hljs-string">"change2"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">ks-page-group</span>&gt;</span>
	// </code></pre>
