...
/***/ function(module, exports, __webpack_require__) {
	...
	var _KHeader = __webpack_require__(131);

	var _KHeader2 = _interopRequireDefault(_KHeader);

	var _KMenu = __webpack_require__(135);

	var _KMenu2 = _interopRequireDefault(_KMenu);

	var _KFooter = __webpack_require__(139);

	var _KFooter2 = _interopRequireDefault(_KFooter);

	var _KCrumbs = __webpack_require__(141);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n<nav class=\"k-header\">\n  <div class=\"k-header__item logo-wrap\">\n    <img class=\"logo\" src=\"" + __webpack_require__(134) + "\"\n         width=\"160\" alt=\"LOGO\">\n  </div>\n</nav>\n";
...
/***/ function(module, exports) {
	...
	exports.default = [{
	  ...
	  subMenu: [{
	    ...
	    { name: 'Icon 图标', icon: 'icon', link: 'icons' }, { name: 'Button 按钮', icon: 'icon', link: 'button' }]
	  }, {
	    ...
	    subMenu: [{ name: 'Tabs 标签页', icon: 'icon', link: 'tabs' }]
	  }, {
	    ...
	    subMenu: [{ name: '限制字符输入', icon: 'icon', link: 'limit-number-fixed' }]
	  }, {
	    name: '其他 Others', icon: 'icon', link: '',
	    subMenu: [{ name: 'Tooltips 弹出提示', icon: 'icon', link: 'tips' }, { name: 'Image 查看', icon: 'icon', link: 'image/v1.0.1' }]
	  }]
	}, {
	  name: '日志 Log',
	  subMenu: [{ name: '更新日志', icon: 'icon', link: 'log' }]
	}];
