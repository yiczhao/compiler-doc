...
/***/ function(module, exports) {
	...
	//            width="160" alt="LOGO">
	//     </div>
	//     <a href="./dist/ks.zip" target="_blanck" style="background: #fdfefe;
	//     float: right;
	//     margin: 8px;
	//     font-weight: bold;
	//     padding: 8px;
...
/***/ function(module, exports) {
	...
	exports.default = [{
	  ...
	  subMenu: [{
	    ...
	    subMenu: [{ name: 'Table 表格', icon: 'icon', link: 'multiple-table' },
	    ...
	    subMenu: [{ name: 'Tooltips 弹出提示', icon: 'icon', link: 'tooltips' }, { name: 'Image 查看', icon: 'icon', link: 'image' }, { name: 'ksImgs 查看', icon: 'icon', link: 'ksimg' }, { name: '多标题表格', icon: 'icon', link: 'multiple-table' }, { name: '定项表格', icon: 'icon', link: 'setitem-table' }]
	  }]
	}, {
	  name: '日志 Log',
