...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] node_modules/vue-markdown-loader/_cache/date-picker-5.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zdzdesigner/Documents/KS/KS-FED/compiler-doc/node_modules/vue-markdown-loader/_cache/date-picker-5.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	// </blockquote>
	// <p>{{datebody}}<br>
	// <ks-date-body v-bind:value.sync="datebody"></ks-date-body></p>
	// <p><ks-button type="success" v-on:click="datebody=''">清空</ks-button></p>
	// <p>{{datebodys}}<br>
	// <ks-date-body v-bind:value.sync="datebodys" type="multi"></ks-date-body></p>
	// <p><ks-button type="success" v-on:click="datebodys=[]">清空</ks-button></p>
	// <blockquote>
	// <h4>dateMonth</h4>
	// </blockquote>
	// <p>{{datemonth}}<br>
	// <ks-date-month v-bind:value.sync="datemonth"></ks-date-month></p>
	...
	// <h4>date</h4>
	// </blockquote>
	// <p><ks-date-picker type="date" v-bind:value="date" v-on:change="date_change"></ks-date-picker></p>
	...
	//     <span class="hljs-attr">v-bind:value</span>=<span class="hljs-string">"date"</span> 
	...
	// <h4>datetime</h4>
	// </blockquote>
	// <p><ks-date-picker type="datetime" v-bind:value="datetime" v-on:change="datetime_change"></ks-date-picker></p>
	...
	//     <span class="hljs-attr">v-bind:value</span>=<span class="hljs-string">"datetime"</span> 
	...
	// </blockquote>
	// <p>{{dateMultiPure}}<br>
	// <ks-dater type="datemulti" v-bind:value.sync="dateMultiPure" v-on:change="dateMultiPureChange"></ks-dater></p>
	...
	// </code></pre>
	// <p>{{datemulti}}<br>
	// <ks-date-picker type="datemulti" v-bind:value.sync="datemulti" v-on:change="datemulti_change"></ks-date-picker></p>
	...
	// <ks-date-range-picker placeholder="开始,结束" v-bind:range.sync="dateRangePicker" v-bind:readonly="false" v-on:change="daterange_picker_change"></ks-date-range-picker></p>
	...
	// </code></pre>
	// <p><ks-date-range-picker placeholder="开始,结束" v-bind:range.sync="dateRangePicker2" v-bind:readonly="false" v-on:change="daterange_picker_change"></ks-date-range-picker></p>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-date-range-picker</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"开始,结束"</span> 
	...
	//                 <span class="hljs-attr">datemonth2</span>:<span class="hljs-string">''</span>,
	...
	//
	//             setTimeout(<span class="hljs-function"><span class="hljs-params">()</span>=&gt;</span>{
	//                 <span class="hljs-keyword">this</span>.datemonth = <span class="hljs-string">'2016-09'</span>
	//             },<span class="hljs-number">1000</span>)
	//         }
	//
	//     }
	...
	exports.default = {
	    data: function data() {
	        return {
	            datebody: '',
	            datebodys: ['2016-10-08', '2016-10-09'],
	            datemonth: '',
	            datemonth2: '2016-10',
