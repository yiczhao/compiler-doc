...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] node_modules/vue-markdown-loader/_cache/button-14.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zdzdesigner/Documents/KS/KS-FED/compiler-doc/node_modules/vue-markdown-loader/_cache/button-14.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	// </code></pre>
	// <h4>按钮的拓展使用 (KsNrButton) 与 (KsGhostButton)</h4>
	// <blockquote>
	// <p><code class="ks-code-inline">KsButton</code> 的默认状态是由 <code class="ks-code-inline">KsNrButton</code> 组件来提供的实现, 下面我来简述一下 <code class="ks-code-inline">KsNrButton</code> 与 <code class="ks-code-inline">KsButton</code> 组件 Api 的差异<br>
	// 与 <code class="ks-code-inline">KsNrButton</code> 暴露的更加具有自定义的一些 Api。</p>
	// </blockquote>
	// <br>
	// <p><ks-nr-button :width="100" :height="30"> AAA </ks-nr-button></p>
	// <br>
	// <p><ks-ghost-button :width="300" :height="40"> BBB </ks-ghost-button></p>
	// <br>
	// <p><ks-nr-button :width="500" :height="32" color-normal="#FF0000" color-hover="#00FF00" color-active="#0000FF"> CCC </ks-nr-button></p>
	// <br>
	// <blockquote>
	// <p>默认不管是 <code class="ks-code-inline">KsNrButton</code> 还是 <code class="ks-code-inline">KsGhostButton</code> 都是不提供颜色的需要自己实现 <code class="ks-code-inline">colorNormal</code> <code class="ks-code-inline">colorHover</code> <code class="ks-code-inline">colorAcitve</code> 来提供按钮主题</p>
	// </blockquote>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-nr-button</span> <span class="hljs-attr">:width</span>=<span class="hljs-string">"100"</span> <span class="hljs-attr">:height</span>=<span class="hljs-string">"30"</span>&gt;</span> AAA <span class="hljs-tag">&lt;/<span class="hljs-name">ks-nr-button</span>&gt;</span>
	// <span class="hljs-tag">&lt;<span class="hljs-name">ks-ghost-button</span> <span class="hljs-attr">:width</span>=<span class="hljs-string">"130"</span> <span class="hljs-attr">:height</span>=<span class="hljs-string">"60"</span>&gt;</span> BBB <span class="hljs-tag">&lt;/<span class="hljs-name">ks-ghost-button</span>&gt;</span>
	// <span class="hljs-tag">&lt;<span class="hljs-name">ks-nr-button</span> <span class="hljs-attr">:width</span>=<span class="hljs-string">"500"</span> <span class="hljs-attr">:height</span>=<span class="hljs-string">"32"</span> <span class="hljs-attr">:color-normal</span>=<span class="hljs-string">"#FF0000"</span> <span class="hljs-attr">:color-hover</span>=<span class="hljs-string">"#00FF00"</span> <span class="hljs-attr">:color-active</span>=<span class="hljs-string">"#0000FF"</span>&gt;</span> CCC <span class="hljs-tag">&lt;/<span class="hljs-name">ks-nr-button</span>&gt;</span>
	// </code></pre>
	// <blockquote>
	// <p>默认按钮的风格样式设计是根据设计原型里的标准, 可以满足大部分需求单不排除有一些定制话的需求, 故在此释出定制化接口来满足一些特殊的需求。</p>
	// </blockquote>
	//
	// <h3>脚本</h3>
	...
	// </tr>
	// </tbody>
	// </table></div><h4>(KsNrButton) 与 (KsGhostButton)</h4>
	// <div class="table-striped"><table class="table-entity"><thead>
	// <tr>
	// <th>参数</th>
	// <th>说明</th>
