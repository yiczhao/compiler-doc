...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] node_modules/vue-markdown-loader/_cache/dialogchoose-12.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zdzdesigner/Documents/KS/KS-FED/compiler-doc/node_modules/vue-markdown-loader/_cache/dialogchoose-12.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        getSidList: function getSidList(val) {
	            this.sid4 = val;
	        }
	    },
	    ready: function ready() {
	        ...
	        this.list1 = JSON.parse((0, _stringify2.default)(_data2.default));
	        this.list2 = JSON.parse((0, _stringify2.default)(_data2.default));
	        this.list4 = JSON.parse((0, _stringify2.default)(_data2.default));
	        this.list3 = JSON.parse((0, _stringify2.default)(this.sex));
	    }
	};
	// </script>
	// <template><section><h2>KsList</h2>
	// <blockquote>
	// <p>常用的弹出框列表选择组件</p>
	// </blockquote>
	// <hr>
	...
	// <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>  
	// </span></code></pre>
	// <p><ks-dialog-choose :list.sync="list2" :sid="sid2" @change="getSid"></ks-dialog-choose><br></p>
	// <div>
	...
	//             <span class="hljs-attr">sid3</span>:[<span class="hljs-string">'086021000000006'</span>],
