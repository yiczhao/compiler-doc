...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] node_modules/vue-markdown-loader/_cache/v1.0.0-4.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zdzdesigner/Documents/KS/KS-FED/compiler-doc/node_modules/vue-markdown-loader/_cache/v1.0.0-4.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	// <blockquote>
	// <blockquote>
	// <h4><strong>KsDatePicker  type=&quot;datemonth&quot;</strong></h4>
	// </blockquote>
	// </blockquote>
	// <p><ks-date-picker type="datemonth" min="2017-11" max="2018-09" v-bind:value.sync="datemonth1"></ks-date-picker></p>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-date-picker</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"datemonth"</span> <span class="hljs-attr">min</span>=<span class="hljs-string">"2017-11"</span> <span class="hljs-attr">max</span>=<span class="hljs-string">"2018-09"</span>
	//     <span class="hljs-attr">v-bind:value.sync</span>=<span class="hljs-string">"datemonth1"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">ks-date-picker</span>&gt;</span>
	// </code></pre>
	// <p><ks-date-picker type="datemonth" max="2017-11" min="2018-09" v-bind:value.sync="datemonth2"></ks-date-picker></p>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-date-picker</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"datemonth"</span> <span class="hljs-attr">max</span>=<span class="hljs-string">"2017-11"</span> <span class="hljs-attr">min</span>=<span class="hljs-string">"2018-09"</span>
	...
	// </code></pre>
	// <p><ks-date-picker type="datemonth" max="2018-09" v-bind:value.sync="datemonth3"></ks-date-picker></p>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-date-picker</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"datemonth"</span> <span class="hljs-attr">max</span>=<span class="hljs-string">"2018-09"</span>
	...
	// </blockquote>
	// <p><ks-date-month v-bind:value.sync="datemonth" min="2018-09"></ks-date-month></p>
	// <pre class="ks-hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">ks-date-month</span> <span class="hljs-attr">v-bind:value.sync</span>=<span class="hljs-string">"datemonth"</span> <span class="hljs-attr">min</span>=<span class="hljs-string">"2018-09"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">ks-date-month</span>&gt;</span>
	// </code></pre>
	// <blockquote>
	// <blockquote>
	...
	//                 <span class="hljs-attr">datemonth1</span>:<span class="hljs-string">'2016-10'</span>,
