...
>> ####  **KsDatePicker  type="datemonth"**

<ks-date-picker type="datemonth" min="2017-11" max="2018-09"
    v-bind:value.sync="datemonth1"></ks-date-picker>
```html
<ks-date-picker type="datemonth" min="2017-11" max="2018-09"
    v-bind:value.sync="datemonth1"></ks-date-picker>
```

<ks-date-picker type="datemonth" max="2017-11" min="2018-09"
...
<ks-date-picker type="datemonth" max="2018-09"
...
> ####  **纯面板KsDateMonth => {{datemonth}}**

<ks-date-month v-bind:value.sync="datemonth" min="2018-09"></ks-date-month>
```html
<ks-date-month v-bind:value.sync="datemonth" min="2018-09"></ks-date-month>
```


>> #### **KsDatePicker type="date" => {{date}}**
...
> #### **KsDatePicker type="datetime" => {{datetime}}**
...
> #### **KsDatePicker type="datemulti" => {{datemulti}}**
...
> #### **纯面板datemulti on KsDater => {{dateMultiPure}}**
...
| min | 最小范围 | props | String | **date=>'2016-11-09'**，**datemonth=>'2016-09'** | 无 |
| max | 最大范围 | props | String | **date=>'2016-11-09'**，**datemonth=>'2016-09'** | 无 |
